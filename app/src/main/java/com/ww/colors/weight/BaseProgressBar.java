...
public class BaseProgressBar extends View {
    ...
    public BaseProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxProgress = a.getInt(R.styleable.CustomProgressBar_progressMax, 100);
        mShownProgress = mActualProgress = a.getInt(R.styleable.CustomProgressBar_progressNow, 0);
